...
public enum ApiError {
    ...
    /**
     * Se usa cuando el cliente intenta realizar una operación no soportada.
     * Ejemplo: Intentar usar un método HTTP inválido como PATCH en un endpoint no soportado.
     */
